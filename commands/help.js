...
exports.run = (client, message, args) => {
    ...
    if(args[0] === "say") {
        ...
        .addField("Usage", "`yabe say <what you want the bot to say>`")
        .setColor(eclr)
    ...
    if(args[0] === "kick") {
        ...
        .addField("Usage", "`yabe kick <@user> <reason>(optional)`")
        .setColor(eclr)
    ...
    if(args[0] === "serverinfo") {
        ...
        .addField("Usage", "`yabe serverinfo`")
        .setColor(eclr)
    ...
    if(args[0] === "learn") {
        ...
        .addField("How to use?", "For starters, the command to initiate the learning mode for Yabe is `yabe learn`. You then add more arguments to that to learn more about specified things.")
        .addField("Examples", "The command to learn about an if statement in JavaScript would be `yabe learn js if`, or to learn about print statements in ruby, you would do `yabe learn rb print`.\n\nTo see what Yabe offers for each language, use `yabe learn <name of language>`\n\nUse `yabe learn langs` to view a list of languages.")
        .setColor(eclr)
    ...
    if(args[0] === "bug") {
        ...
        .addField("Usage", "`yabe bug <bug message>`")
        .setColor(eclr)
    ...
    if(args[0] === "whois") {
        ...
        .addField("Usage", "`yabe whois <name of role>")
        .setColor(eclr)
    ...
    if(args[0] === "rem") {
        ...
        .addField('Usage', '`yabe rem <amount of messages to be removed>`')
        .setColor(eclr)
    ...
    if(args[0] === "avatar") {
        ...
        .addField("Usage", "`yabe avatar <desired user(without @)/leave blank for own>`")
        .setColor(eclr)
    ...
    if(args[0] === "poke") {
        ...
        .addField('Usage', '`yabe poke <person to poke>`')
        .setColor(eclr)
    ...
    if(args[0] === "slap") {
        ...
        .addField('Usage', '`yabe slap <person to slap>`')
        .setColor(eclr)
